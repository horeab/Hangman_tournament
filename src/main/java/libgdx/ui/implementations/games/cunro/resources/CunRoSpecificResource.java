package libgdx.ui.implementations.games.cunro.resources;
...
public enum CunRoSpecificResource implements SpecificResource {
    ...
    CunRoSpecificResource(String path, Class<?> classType) {
        this.path = path;

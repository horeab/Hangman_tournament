package libgdx.ui.implementations.games.countryhistro.resources;
...
public enum CountryHistRoSpecificResource implements SpecificResource {
    ...
    CountryHistRoSpecificResource(String path, Class<?> classType) {
        this.path = path;

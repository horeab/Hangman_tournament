package libgdx.ui.implementations.games.capitals.resources;
...
public enum CapitalsSpecificResource implements SpecificResource {
    ...
    CapitalsSpecificResource(String path, Class<?> classType) {
        this.path = path;

...
public class QuestionConfig {
    ...
    public QuestionConfig(int amountOfQuestions) {
        this(new ArrayList<QuestionDifficulty>(Arrays.asList(EnumUtils.getValues(TournamentGame.getInstance().getSubGameDependencyManager().getQuestionDifficultyTypeEnum()))),
                new ArrayList<QuestionCategory>(Arrays.asList(EnumUtils.getValues(TournamentGame.getInstance().getSubGameDependencyManager().getQuestionCategoryTypeEnum()))),
                amountOfQuestions);
    }
    ...
    public QuestionConfig(QuestionDifficulty questionDifficulty, int amountOfQuestions) {
        this(Collections.singletonList(questionDifficulty), new ArrayList<QuestionCategory>(Arrays.asList(EnumUtils.getValues(TournamentGame.getInstance().getSubGameDependencyManager().getQuestionCategoryTypeEnum()))), amountOfQuestions);
    }
    ...
    public QuestionConfig(List<QuestionCategory> questionCategory, int amountOfQuestions) {
        this(new ArrayList<QuestionDifficulty>(Arrays.asList(EnumUtils.getValues(TournamentGame.getInstance().getSubGameDependencyManager().getQuestionDifficultyTypeEnum()))), questionCategory, amountOfQuestions);
    }
    ...
    private QuestionDifficulty getRandomQuestionDifficulty() {
        ...
        return (QuestionDifficulty) EnumUtils.getEnumValue(TournamentGame.getInstance().getSubGameDependencyManager().getQuestionDifficultyTypeEnum(), list.get(0));
    }

    private QuestionCategory getRandomQuestionCategory() {
        ArrayList<String> list = new ArrayList<String>(c);
        Collections.shuffle(list);
        return (QuestionCategory) EnumUtils.getEnumValue(TournamentGame.getInstance().getSubGameDependencyManager().getQuestionCategoryTypeEnum(), list.get(0));
    }

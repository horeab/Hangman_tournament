...
public class LeaderboardButtonBuilder extends ImageButtonBuilder {


    public LeaderboardButtonBuilder() {
        super(ButtonSkin.LEADERBOARD, TournamentGame.getInstance().getAbstractScreen());
